...
const MESSAGE = 'You must supply `@public`, `@private`, or `@protected` for block comments.';
...
module.exports = {
  ...
  create(context) {
    ...
    function includesAccessDeclaration(title) {
      ...
      return validTags.indexOf(title) !== -1;
    }
    ...
    function checkJSDoc(node) {
      ...
      if (jsdocNode) {
        ...
        try {
          ...
          return context.report({ node: jsdocNode, message: 'JSDoc syntax error.' });
        }
